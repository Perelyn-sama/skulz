...
contract SkullToons is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    ...
    event SkullToonsummoned(address to, uint256 indexed id);
    ...
    constructor() ERC721("The Real Skull Toons", "RealSkullToons") {
